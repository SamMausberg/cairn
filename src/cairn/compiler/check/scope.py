...
from ..syntax.tree import Expr, Function, Type
...
class Scope:
    ...
    coop: Block | None = None  # The cooperative region being checked (cooperative.py); its lanes are threads.
...
class Block:
    ...
    and meet at its barriers (compiler/cooperative/cooperative.py)."""
    ...
    pipelines: dict[str, Any] = field(default_factory=dict)  # name -> its stages (compiler/cooperative/pipelines.py)
