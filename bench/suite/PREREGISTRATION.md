...
Read this next to [testing.md](../../docs/testing.md), which says which claims are kept apart. Accepted, typed, native-built, finite-tested, sanitizer-clean, SMT-equivalent, Lean-checked and benchmarked are different statements. Nothing here establishes any of the others.
