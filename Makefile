...
DEVICE_TESTS = tests/language/test_assembly.py tests/language/test_assert_eq.py tests/language/test_gradients.py \
  ...
  tests/soundness/test_tensor_kernels.py tests/soundness/test_wide.py tests/soundness/test_atomics.py tests/soundness/test_finish.py tests/soundness/test_written.py \
