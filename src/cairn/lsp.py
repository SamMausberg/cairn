...
from .agent_tools import explain, local, signature
...
from .modules import STD, library_path
from .syntax import IDENT, INTRINSIC_TYPES, RESERVED, SCALAR, Function, Program
from .traits import CLASSES, KINDS
...
def occurrences(doc: Document, offset: int) -> list[Item]:
    ...
    alias or an imported name. `docs/tooling.md` states the rule for the people it refuses."""
    cs = doc.code
    at = word_at(doc, offset)
