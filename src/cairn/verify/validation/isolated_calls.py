...
One child process (`python -m cairn.verify.validation.isolated_calls`) loads the libraries under test and answers one JSON
...
class Calls:
    ...
    def __init__(self, memory_mib: int = 2048):
        ...
        self.process = subprocess.Popen(
            [sys.executable, "-m", "cairn.verify.validation.isolated_calls"], stdin=subprocess.PIPE, stdout=subprocess.PIPE,
