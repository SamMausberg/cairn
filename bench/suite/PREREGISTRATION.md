...
What this can add to a result is a ratio between CAIRN as it now emits and a C++ baseline that checks exactly what CAIRN still checks. It says nothing new about the guarded column, which keeps the 0.8.3 meaning: the price of every guard the 1.3 emitter wrote.
