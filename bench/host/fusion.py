...
Only the host runs anything: `cairn.perf.measure` refuses device code.
    ...
    python3 bench/host/fusion.py [--rounds 3] [--out results/fusion/fusion.json]
    python3 bench/host/fusion.py --reprice results/fusion/fusion.json   # the model's columns again, nothing timed
"""
