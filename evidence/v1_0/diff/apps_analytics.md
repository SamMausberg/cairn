...
Compared by `cairn diff` (cairn-native/0.8.3): 78 identical-code, 5 identical-source, 12 unknown. A function whose code is identical, with everything it calls, is counted and not listed.
