"""docs/tour.md is executable: every program in it is compiled, built and run; it must exit 0."""
...
TOUR = (pathlib.Path(__file__).resolve().parents[1] / "docs/tour.md").read_text(encoding="utf-8")
