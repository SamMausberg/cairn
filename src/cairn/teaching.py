...
CARDS={
'base':'''CAIRN Native 0.5, CPU profile. Use fn, typed parameters, braces, semicolons,
...
Expression body: fn inc(x:u64)->u64 = add_wrap(x,1);
This is exactly one explicit return, not a closure. Blocks still require return.
Native host views may omit @host: ro<u64>[n] is the same host borrow.
There is no inferred GPU transfer or automatic allocation.
