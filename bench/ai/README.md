...
Ten small systems tasks given to fresh model subjects in CAIRN, C++ and Rust, with the same budget in every language. [PREREGISTRATION.md](PREREGISTRATION.md) fixes the design, and `evidence/v1_5/ai_benchmark/` holds the results.
