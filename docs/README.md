...
| [concurrency.md](concurrency.md) | Tasks and leases, task groups, I/O rings, atomics and mutexes, parallel regions, plans and fusion, `reduce`, `compact` and `scan`, placement, queued device work, device execution and cooperative regions. |
