...
- an entry in the reference file that owns it (`docs/language.md`, `docs/memory.md`, `docs/abstractions.md` or `docs/concurrency.md`) and in `docs/project/capabilities.json`;
