...
| `Cairn/Layout.lean` | The layout rules of `compiler/layouts.py` as their definitions, what a layout that passes promises, and one example of each refusal. |
