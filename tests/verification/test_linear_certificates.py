...
from cairn.verify.linear_certificates import Certificate, audit_collector, check, collector_rules
...
def test_compiler_refuses_failed_certificate(monkeypatch):
    import cairn.verify.linear_certificates as m
...
def test_lean_status_follows_the_exact_bundle(monkeypatch):
    ...
    import cairn.verify.linear_certificates as lc
