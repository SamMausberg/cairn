...
Compared by `cairn diff` (cairn-native/1.3.0): 6 identical-code, 2 unknown. A function whose code is identical, with everything it calls, is counted and not listed.
