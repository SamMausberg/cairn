...
syntax match cairnContext /\v<(after|barrier|block|blocks|clobbers|depth|exclusive|fold|fuse|grain|implements|into|lanes|launch|layout|lends|needs|out|per_lane|pipeline|plan|recipe|require|scan|shared|stage|test|threads|unroll|use|vector|volatile|warp|when)>\ze\s+[[:alnum:]_"$+*&|^-]/
