...
Compared by `cairn diff` (cairn-native/0.8.3): 6 identical-code, 2 unknown, 2 signature-changed, 3 added, 1 removed. A function whose code is identical, with everything it calls, is counted and not listed.
