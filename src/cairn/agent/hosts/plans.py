...
A body edit (`edits.py`) may rewrite a function within its signature and ceiling. A plan edit is narrower and
...
to the function before is removed, wherever it was written (`perf/tuning/plan_source.py`).
...
from ...perf.tuning.plan_source import Placement, text, written
from ...perf.tuning.tune import now, regions
from ...projects.project import Project
from ..projection import signature
from .edits import digest, load_json_strict, shaped, stable_json
