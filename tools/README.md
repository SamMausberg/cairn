...
| `release/` | the release gates' collectors, the repository audit, the opt-in private publisher, and the label sync with the strict reader of the YAML under `.github/` |
