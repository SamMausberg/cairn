...
the numerical policy (verify/validation/agreement.py), and Z3 does not know the domain the host admits. So a counterexample is
...
def smt(base: str, reference: str, implementation: str, impl: Function, policy: Any,
    ...
    from ..scalar.values import MAX_UNROLL
