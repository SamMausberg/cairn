...
Compared by `cairn diff` (cairn-native/0.8.3): 7 identical-code, 2 unknown. A function whose code is identical, with everything it calls, is counted and not listed.
