...
Compared by `cairn diff` (cairn-native/0.8.3): 3 identical-code, 4 unknown. A function whose code is identical, with everything it calls, is counted and not listed.
