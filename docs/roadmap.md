...
- The elision audit's own rules in Lean, and a record of each guard lowering leaves out, naming the emitted operation and the facts that discharge it, which a checker outside the compiler can replay.
