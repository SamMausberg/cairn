...
there are E-REDUCE-ORDER. plan f { grain 1; lanes 8; } picks how f's host regions are split over the pool and
changes no result (E-PLAN names a function without one). Lanes cannot return, nest or move outer owners, and
