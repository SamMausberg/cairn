...
`syntax_statements.py` adds statements and `syntax.py` adds declarations and the entry point; the three are one
...
class ExpressionParser:
    ...
    # The statement grammar (syntax_statements.py) supplies these; an expression holds a block or a region.
