...
| `v1_5/` | Records of the work after 1.4, taken as it landed, one directory per subject with a README saying what ran and what did not: `demos/` for the three demos, `trim/` for the pass that shared duplicated logic in `src/cairn`. |
