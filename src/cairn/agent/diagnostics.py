...
HINTS = {
    ...
    "E-COOP-UNORDERED": "Put a barrier between the write and the read the refusal names; every thread must reach it.",
    "E-COOP-REUSE": "Put a barrier after the last read of the old value, before the thread rewrites the element.",
    "E-COOP-CONFLICT": "Give each thread its own element of the shared array, for example tile[t], in a phase.",
    ...
    "E-STAGE-BUSY": "Put a barrier after release and before the next fill, or give the pipeline one more stage.",
