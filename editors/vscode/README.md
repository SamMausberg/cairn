...
- Completion, signature help, go to definition (into the packaged `std` too), references, rename within the file, the document outline and `Format Document`, which is `cairn fmt`.
