...
Any other editor with an LSP client can run `cairn lsp` over stdio. Shell completions and a watched check that prints JSON Lines are in [docs/tools.md](../docs/tools.md#a-watched-check-and-shell-completions).
