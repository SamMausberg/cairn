...
# What a device lane, and whatever it calls, may do: typed PTX (compiler/primitives/machine.py) whose declared effects stay
# within this set, reads and writes the lane rule judged, and atomic updates of one element (compiler/primitives/atomics.py).
