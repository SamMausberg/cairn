...
Sent to an agent when the program uses `buffer`, `len`, `stack`. Codes: `E-ALIAS`, `E-CALL-SHAPE`, `E-CALL-VIEW`, `E-ESCAPE`, `E-EXTENT`, `E-INDEX`, `E-LEN`, `E-VIEW-ALIAS`, `E-WRITE-LEASE`.
