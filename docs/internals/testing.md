...
```sh
python3 tools/checks/validate_systems.py
```
...
```sh
python3 tools/checks/verify.py --gcc --sanitize
python3 bench/cpu/codegen_only.py
python3 tools/checks/validate_semantics.py --gcc
```
...
```sh
python3 tools/ai/measure_context.py
python3 tools/checks/density.py
```
